...
const SocialButton = ({ icon, text, onClick }) => (
    <motion.button
        ...
        onClick={onClick}
        style={{
            width: "100%", padding: "14px", borderRadius: 14, border: "1px solid #e5e5e5",
            background: "#ffffff", color: "#09090b", fontSize: "15px", fontWeight: 600,
            display: "flex", alignItems: "center", justifyContent: "center", gap: "10px",
            cursor: "pointer", transition: "border-color 0.2s", marginBottom: "12px",
...
export default function AuthPage({ onBack, onAuthSuccess }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                // Save standard login credentials
        ...
        <div style={{ display: "flex", minHeight: "100dvh", fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, sans-serif", backgroundColor: "#ffffff" }}>
            <style>{`
                ...
                * { box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
                ...
                /* Adding a scrollbar to the right side for smaller laptop screens */
