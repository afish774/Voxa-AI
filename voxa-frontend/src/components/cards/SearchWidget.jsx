...
const SearchWidget = ({ data }) => {
  ...
  return (
    <motion.div
      ...
      className="relative w-full max-w-[400px] rounded-2xl overflow-hidden mt-4"
      style={{
        background: '#0B0B0C',
      ...
      <div className="relative z-10 flex items-center gap-3.5 px-5 py-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1.5 mb-0.5">
            ...
            <span className="text-[10px] font-semibold uppercase tracking-[0.12em] text-indigo-400/60">Deep Research</span>
          </div>
          <p className="text-[13px] text-[#A1A1AA] font-medium truncate leading-snug">
            {query}
          </p>
        </div>
