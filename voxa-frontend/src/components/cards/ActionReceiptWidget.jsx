...
const ActionReceiptWidget = ({ data }) => {
  ...
  return (
    <motion.div
      ...
      className="flex items-center gap-3 mt-4 px-5 py-3.5 rounded-2xl w-fit max-w-[400px]"
      style={{
    ...
    >
      ...
      <span className="text-[14px] text-[#D4D4D8] font-medium leading-snug tracking-[-0.01em]">
        {cleanMessage}
      </span>
    </motion.div>
  );
