...
export const getSportsDataTool = tool(
    async ({ sport, query, temporal_intent, tournament, team_mentions, specific_date }) => {
        try {
            ...
            // ==================================================================
            // 🏏 ROUTE 3: CRICKET (CRICBUZZ RAPID-API INTEGRATION)
            // 🛠️ AUDIT FIX: [PATH A] — Unofficial Cricbuzz API bypasses CricAPI blocks.
            // Automatically merges live, recent, and upcoming feeds into our engine.
            // ==================================================================
            else if (
                ...
                // Parallel fetch of Cricbuzz endpoints
                const [liveData, recentData, upcomingData] = await Promise.all([
                    fetchWithCacheAndRetry('https://cricbuzz-cricket.p.rapidapi.com/matches/v1/live', { headers: rapidHeaders }, 30000),
                    fetchWithCacheAndRetry('https://cricbuzz-cricket.p.rapidapi.com/matches/v1/recent', { headers: rapidHeaders }, 120000),
                    fetchWithCacheAndRetry('https://cricbuzz-cricket.p.rapidapi.com/matches/v1/upcoming', { headers: rapidHeaders }, 300000)
                ]);

                // Helper to flatten nested Cricbuzz API structures
                ...
                // Data Normalizer: Maps Cricbuzz format exactly to our scoring engine format
